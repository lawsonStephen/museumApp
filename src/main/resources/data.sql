...
INSERT INTO PAINTING (id, IMAGE_PATH, name, painting_price, painting_year, museum_id, artist_id) VALUES
    (default, 'images/paintings/sunflowers.jpeg', 'Sunflowers', 10, 1923, SELECT id FROM museum WHERE name = 'Van Gogh Museum', SELECT id FROM artist WHERE name = 'Van Gogh'),
    (default, 'images/paintings/Buste de femme.jpg', 'Buste de femme', 10, 1943, SELECT id FROM museum WHERE name = 'Louvre', SELECT id FROM artist WHERE name = 'Picasso'),
    (default, 'images/paintings/sistine chapel.jpeg', 'Sistine Chapel Ceiling', 80, 1512, SELECT id from museum where name = 'Sistine Chapel', select id from artist where name = 'Michelangelo'),
    (default, 'images/paintings/sunflowers.jpeg', 'Wheatfield with Crows', 117, 1890, SELECT id from museum where name = 'Van Gogh Museum', select id from artist where name = 'Van Gogh'),
    (default, 'images/paintings/sunflowers.jpeg', 'Mona Lisa', 870, 1517, SELECT id from museum where name = 'Louvre', select id from artist where name = 'da Vinci'),
    (default, 'images/paintings/sunflowers.jpeg', 'Sunflowers', 100, 1888, SELECT id FROM museum WHERE name = 'Van Gogh Museum', SELECT id FROM artist WHERE name = 'Van Gogh'),
    (default, 'images/paintings/sunflowers.jpeg', 'Buste de femme', 10, 1943, SELECT id FROM museum WHERE name = 'Louvre', SELECT id FROM artist WHERE name = 'Picasso'),
    (default, 'images/paintings/sunflowers.jpeg', 'Sistine Chapel Ceiling', 80, 1512, SELECT id FROM museum WHERE name = 'Sistine Chapel', SELECT id FROM artist WHERE name = 'Michelangelo'),
    (default, 'images/paintings/sunflowers.jpeg', 'Wheatfield with Crows', 117, 1890, SELECT id FROM museum WHERE name = 'Van Gogh Museum', SELECT id FROM artist WHERE name = 'Van Gogh'),
    (default, 'images/paintings/sunflowers.jpeg', 'Mona Lisa', 870, 1517, SELECT id FROM museum WHERE name = 'Louvre', SELECT id FROM artist WHERE name = 'da Vinci'),
    (default, 'images/paintings/sunflowers.jpeg', 'The Starry Night', 125, 1889, SELECT id FROM museum WHERE name = 'Museum of Modern Art', SELECT id FROM artist WHERE name = 'Van Gogh'),
    (default, 'images/paintings/sunflowers.jpeg', 'The Persistence of Memory', 110, 1931, SELECT id FROM museum WHERE name = 'Museum of Modern Art', SELECT id FROM artist WHERE name = 'Dali'),
    (default, 'images/paintings/sunflowers.jpeg', 'The Kiss', 90, 1908, SELECT id FROM museum WHERE name = 'Hermitage Museum', SELECT id FROM artist WHERE name = 'Klimt'),
    (default, 'images/paintings/sunflowers.jpeg', 'Night Watch', 140, 1642, SELECT id FROM museum WHERE name = 'Rijksmuseum', SELECT id FROM artist WHERE name = 'Rembrandt'),
    (default, 'images/paintings/sunflowers.jpeg', 'The School of Athens', 160, 1510, SELECT id FROM museum WHERE name = 'Vatican Museums', SELECT id FROM artist WHERE name = 'Raphael');
